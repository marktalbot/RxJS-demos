...
/***/ function(module, exports, __webpack_require__) {
	...
	var activeItems = document.querySelector('#active');
	var doneItems = document.querySelector('#done');
	var listItem = function listItem(todo) {
	...
	var appState = new _Rx2.default.BehaviorSubject({ todos: [] });

	// Actions and dispatcher functions
	// ==================================
	var dispatcher = function dispatcher(actionFn) {
	    return function () {
	        return appState.next(actionFn.apply(undefined, arguments));
	    };
	};
	var action = dispatcher(function (obj) {
	    return { type: obj.type, data: obj.payload };
	});
	...
	function updateView(state) {
	    activeItems.innerHTML = state.todos.filter(function (todo) {
	        return !todo.done;
